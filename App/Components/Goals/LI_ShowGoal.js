...
import LI_GoalDetail
  from '../../Containers/Goals/LI_GoalDetail'
import LI_EditGoal
  from '../../Containers/Goals/LI_EditGoal'
import LI_Sell
...
class LI_ShowGoal extends Component {
  ...
  returnTypeMap () {
    const {navigator, childID, goalID, foo} = this.props
      ...
      case 'buy':
        return (
          <View style={{width: width}}>
            <LI_Buy navigator={navigator} hideModal={foo} goalID={goalID} childID={childID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
          </View>
        )
      case 'sell':
        return (
          <View style={{width: width}}>
            <LI_Sell navigator={navigator} hideModal={foo} goalID={goalID} childID={childID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
          </View>
        )
      case 'edit':
        return (
          <View style={{width: width}}>
            <LI_EditRecurring navigator={navigator} childID={childID} hideModal={foo} goalID={goalID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
          </View>
        )
      case 'change':
        return (
          <View style={{width: width}}>
            <LI_EditGoal navigator={navigator} childID={childID} goalID={goalID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
          </View>
        )
      default:
        return <LI_Sell navigator={navigator} investmentID={goalID} childID={childID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
    }
  }

  returnMap (key) {
    const {navigator, childID, goalID} = this.props
    const {width} = Dimensions.get('window')
    switch (key) {
      case 0: {
        return (
          <View style={{width: width}}>
            <LI_GoalDetail navigator={navigator} goalID={goalID} childID={childID} popFunc={this.handlePrevious.bind(this)} pushFunc={this.handleNext.bind(this)} />
          </View>
        )
      }
      case 1: {
